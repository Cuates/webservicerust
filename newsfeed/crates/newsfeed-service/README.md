...
- **Orchestration**: Enforces strict 500-item batch limits for bulk operations and manages the partial-success transactional state, ensuring all operations are cleanly mapped before touching the database.
